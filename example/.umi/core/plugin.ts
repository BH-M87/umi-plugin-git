...
import * as Plugin_0 from '/Users/liuxuheng/OwnDevWorkspaces/umi-plugin-git/example/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/liuxuheng/OwnDevWorkspaces/umi-plugin-git/example/app.tsx',
    },
  ];
}
